		...
		<article id="blog-body">
			...
			<section class="blog-text">
				<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
					Iste molestiae placeat officiis. Dolorum exercitationem dolorem
					vitae cumque cum, rem unde doloribus consectetur corporis quae quas
					eligendi aliquam molestiae maiores eaque.</p>
			</section>
		</article>
	</section>
	<footer>

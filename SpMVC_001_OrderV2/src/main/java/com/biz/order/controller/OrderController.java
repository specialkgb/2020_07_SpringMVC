...
public class OrderController {
	 ...
	 * 이미 생성되어 Container에 보관중인 OrderServiceImplV1 객체를
	...
	// a href="input"로 설정된 링크를 클릭했을 때 응답할 method
	...
	/* 사용자가 browser에서 order request를 실행할 때(요청할 때)
	...
	public String getOrder(String seq, String name, Model model) {
		...
		try {
			...
			System.out.println("SEQ값을 수신하지 못함, 잘못된 SEQ를 받음");
		}		
		 ...
		 * 이때, model에 담겨있는 데이터를 사용하여 rendering 할 때 사용하라
		 */
	...
	public String insert(
		...
		System.out.println("주문번호 : " + o_date);
		...
		/*
		 * web browser의 주소창에 .../order/list라고 입력한 후 enter를 누른것과 같이

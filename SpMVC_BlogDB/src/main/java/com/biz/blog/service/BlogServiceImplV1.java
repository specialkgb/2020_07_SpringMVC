...
/*
 * org.springframework.beans.factory.NoSuchBeanDefinitionException: No qualifying bean of type 'com.biz.blog.service.BlogService' available
 * spring 프로젝트에서 서버를 시작했을 때 매우 자주 만나는 exception
...
public class BlogServiceImplV1 implements BlogService{
	// 객체주입
	// @Autowired를 써주지 않으면: NullPointerException을 보게된다!
	@Autowired
	...
	public List<BlogVO> selectAll() {
		...
		// BlogDao 인터페이스를 구현한 클래스를 만들고, 객체로 생성하여 사용할 수 있도록 해달라

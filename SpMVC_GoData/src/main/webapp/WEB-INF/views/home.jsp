...
<head>
<meta charset="UTF-8">
<title>공공 API 검색</title>
<link rel="stylesheet" href="${rootPath}/static/css/main.css?ver=2020-12-09">
					...
					function() {
						...
						select_cat.onchange = function(e) {
							...
							if (value === 'hosp') {
								...
								document.querySelector("input[name='search']").placeholder = '병원명 입력후 Enter..'
		...
		<ul>
			...
			<li>
				<form>
					...
					</select> <input name="search" type="search" placeholder="병원 이름 입력 후 Enter">
				</form>
			</li>
			<li>
